...
; при смещении баг из-за
; table_00_89FD_9442:
; там должно быть несколько word
; поправить во всех звуках

; внутри звука обратить внимание на байт D0 и D1, это вроде как повторы с поинтерами
