...
.import _b07_D073
.import _b07_EF54_отобразить_спрайты_слева_8_пикселей
.import _b07_EB8C
.import _b07_E828
.import _b07_EFAD_работа_с_видеопамятью
...
bra_05_9A43:
	LDA #ЗВУК_ПОЛОЖИТЕЛЬНЫЙ
	JSR _b07_C2E4_записать_и_воспроизвести_звук
	JSR _loc_05_9E60_поменять_циферку_на_тайл_позиции_в_расстановке
	INC номер_опции + 1
	LDA номер_опции + 1
	CMP #$06
	BEQ bra_05_9A5B
...
_loc_05_9E60_поменять_циферку_на_тайл_позиции_в_расстановке:
	LDX #$0C
	JSR _loc_05_82F4
	LDY счетчик_смен
	LDA расстановка_команды,Y
	ASL
	TAY
	LDA table_05_9F3A_тайлы_позиций,Y
	STA $32
	LDA table_05_9F3A_тайлы_позиций + 1,Y
	STA $33
	LDA номер_опции + 1
	ASL
	TAY
...
table_05_9F3A_тайлы_позиций:
.SCOPE
.word table_расстановка_1
.word table_расстановка_2
.word table_расстановка_3

table_расстановка_1:
.byte $18,$17,$1A,$19,$1A,$19,$16,$15,$16,$15,$14,$13

table_расстановка_2:
.byte $18,$17,$1A,$19,$1A,$19,$18,$17,$16,$15,$14,$13

table_расстановка_3:
.byte $18,$17,$1A,$19,$18,$17,$16,$15,$16,$15,$14,$13
.ENDSCOPE
...
bra_05_A21E:
	...
	LDA $2D
	STA байт_2006_hi_атрибуты
	JMP _b07_EFAD_работа_с_видеопамятью
...
_loc_05_B233:		; выглядит бесполезным, адреса в итоге нигде не читаются, проверить прыжки и удалить
...
_loc_05_B24C:		; выглядит бесполезным, адреса в итоге нигде не читаются, проверить прыжки и удалить
; $0617 (начальный Y = 01) $0618 $0619 $061A $061B $061C $061D $061E
	JSR _loc_05_B222
	LDY #$01
bra_05_B251:
	LDA ($30),Y
