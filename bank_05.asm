...
table_05_865B:
.byte $00,$01,$01,$01,$02,$02,$03,$04,$05,$06,$06,$06,$07,$07,$07,$07
...
; выставить базовые параметры при наведении на одну из трех опций режима игры
	...
	LDA опция_режим_сложность
	AND #$03
	ORA table_05_8687_режим,Y		; благодаря ORA сложность не меняется при отмене
	STA опция_режим_сложность
	LDA table_05_8687_колво_игроков + 1,Y
	STA количество_игроков
	RTS

table_05_8687_режим:
table_05_8687_колво_игроков:
; bzk 021 удалены лишние 2 байта так как четвертого режима не существует
.byte $80,$01
.byte $40,$02
.byte $20,$01
...
bra_05_B41E:
	...
	STA $1C
	LDA опция_режим_сложность
	AND #СЛОЖНОСТЬ_СУММА_СЛОЖНОСТЕЙ
	STA $1E
	TAY
	LDA table_05_B469,Y
	STA $1D
