...
; на этот RTS есть прыжок, удалить
_loc_05_8DBB:
	RTS
...
table_05_A6C9:
.byte $04,$06,$03,$05,$0D,$01,$07,$FF

table_05_A6D1:		; читается из 3х мест
.byte $07,$03,$0D,$05,$06
...
_loc_05_B9C4:
table_05_B9C4:		; какая-то кривая таблица видимо, если читает байты кода
