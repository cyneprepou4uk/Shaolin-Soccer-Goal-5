...
_loc_04_BBEC:
; bzk 022 из одной таблицы BD4A сделано 2
	LDA номер_супера
	ASL
	TAY
	LDA table_04_BD69,Y
...
; bzk 022 добавлен байт 00 в начало таблицы, видимо он читался из предыдущей в оригинале, а также свапнуты байты местами
