...
; bzk 022 из одной таблицы BD4A сделано 2
	...
	STA разновидность_супера
	TAY
	LDA table_04_BD4A_падение_1,Y		; 60фпс возможно
	BEQ @пропуск
	STA $2D
	LDA #$00
	STA $2C
...
table_04_BD4A_падение_1:
.byte $08,$08,$08,$10,$08,$00,$00,$08,$04,$04

table_04_BD4A_падение_2:
.byte $00,$F8,$01,$04,$00,$00,$01,$00,$00,$06
