...
_loc_04_BC62_записать_таймер_супера:
	...
	LDA $2C
.byte $F2,$03		; DMA 03 умножение 60fps длительность супера
@запись_таймера:
	STA таймер_действия_мяча
	LDA #$00
	STA гравитация_hi,X
	LDA #$0E		; 60fps !!! гравитация удара
	STA гравитация_lo,X
	RTS
...
table_04_BD4A_скорость_Z:	; 60fps !!! скорости некоторых суперов, например красный ближний
...
; 60фпс
; 60fps !!! ??? частично таймер полята мяча частично
table_04_BD5E_таймеры:
; обычный удар, красный ближний, красный дальний, ..., звезда
.byte $30,$18,$FF,$7F,$7F,$20,$60,$FF,$7F,$00,$00
...
table_04_BDD7_высота_удара_с_ноги:		; 60fps !!! корректировка высоты для возможности супера
.byte $10,$1C,$20,		$24,$1C,$14
;.byte $10,$1C,$24,		$24,$1C,$14

table_04_BDDD_высота_удара_головой:		; 60fps !!! корректировка высоты для возможности супера
