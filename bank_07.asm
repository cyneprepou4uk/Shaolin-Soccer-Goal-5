...
.export _b07_0002_корректировка_байтов_управляемых
_b07_0002_корректировка_байтов_управляемых:
.SCOPE
	LDX #$03
@цикл:
	JSR _цикл
...
_цикл:
	LDA номер_управляемого,X
	TAY
	BMI @игрок_не_управляется
	LDA позиция_управление,Y
	AND #$7F	; снимаем флаг бота
	STA позиция_управление,Y
	RTS
@игрок_не_управляется:
	LDA позиция_управление,Y
	ORA #$80	; превращаем в бота
	STA позиция_управление,Y
	RTS
.ENDSCOPE
