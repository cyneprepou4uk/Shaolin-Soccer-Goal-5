...
.import _loc_06_801B_вычислить_скорости_по_углу
.import _loc_06_801E
.import _loc_06_8021
.import _loc_06_8024
.import _loc_06_8027
...
.byte $06, < _loc_06_801B_вычислить_скорости_по_углу		; $26
...
bra_07_C5C9:
	...
	STA флаг_отрисованного_статусбара_ХЗ
...
_b07_CDCB:
	...
	BEQ bra_07_CDE2
	LDA #$08		; 60fps когда игрок стоит на мяче
	STA гравитация_lo,X
	LDA #$00
	STA гравитация_hi,X
	RTS
...
; 60fps учетверение таймингов анимации, временное решение
	STA $0190
	ASL
	ASL
...
@продолжить:
	...
	STA байт_для_2000
	STA $2000
	LDA флаг_отрисованного_статусбара_ХЗ
	BEQ bra_07_E1F8
	LDA вид_статусбара
	AND #$7F
	ASL
...
bra_07_E209:
	...
	DEX
	BPL bra_07_E209
	INC флаг_отрисованного_статусбара_ХЗ
	RTS
...
_loc_07_FB5F:
	...
	CMP #$13		; 60fps интервал между нажатием вперед + вперед или вверх + вверх, увеличен в 3 раза
	BCS bra_07_FB89
...
.export _b07_0003_корректировка_байтов_управляемых_когда_мяч_внеИгры
_b07_0003_корректировка_байтов_управляемых_когда_мяч_внеИгры:
.SCOPE
	LDA позиция_управление + $0A
	ORA #$80
	STA позиция_управление + $0A
...
.export _b07_деление_и_умножение_скоростей_16bit_на_4
_b07_деление_и_умножение_скоростей_16bit_на_4:		; 60fps
.SCOPE
