...
bra_07_EFCC:
	...
	BEQ _loc_07_EFE5_запись_в_видеопамять_трех_буферов
	JMP _loc_07_C244
bra_07_EFD4:	; 60fps !!! удалено поочередное выполнение последних трех подпрограмм на трех отдельных кадрах
	LDA #$01
	STA $401C
	...
	JSR _loc_07_F340_рисовка_таймера_и_следов
	LDA #$00
	STA $401C
	RTS
...
_loc_07_F340_рисовка_таймера_и_следов:
.SCOPE
	LDA подтип_экрана
	CMP копия_подтипа_экрана
	BNE @RTS
