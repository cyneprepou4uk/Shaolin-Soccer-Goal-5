...
bra_02_AD5B:
	...
	LDY #$80		; 60fps отскок от стены на экране с кунио
	LDA координата_X_hi_мяча
	BNE bra_02_AD72
	LDA координата_X_lo_мяча
	CMP #$02		; 60fps уменьшено в 4 раза
	BCS bra_02_AD90
	BCC bra_02_AD76
bra_02_AD72:
	BMI bra_02_AD76
...
bra_02_AD76:
	...
	LDA #$80		; 60fps отскок от стены на экране с кунио
	STA скорость_Z_lo_мяча
	LDA #$00		; 60fps отскок от стены на экране с кунио
	STA скорость_Z_hi_мяча
	LDA #$08		; 60fps отскок от стены на экране с кунио
