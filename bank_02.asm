...
.incbin "_tbl_bank_02.dat"		; таблицу не трогать и не перемещать
...
bra_02_AD5B:
	...
	AND #$40
	BNE bra_02_AD90
	LDX #$00		; 60fps !!! норм отскок от стены на экране с кунио
	LDY #$AB		; 60fps !!! норм отскок от стены на экране с кунио
...
bra_02_AD72:
	BMI bra_02_AD76
	LDX #$FF		; 60fps !!! норм отскок от стены на экране с кунио
	LDY #$55		; 60fps !!! норм отскок от стены на экране с кунио
bra_02_AD76:
	STY скорость_X_lo_мяча
	STX скорость_X_hi_мяча
	LDA #$06
	STA номер_движения_мяча
	LDA #$AB		; 60fps !!! норм отскок от стены на экране с кунио
	STA скорость_Z_lo_мяча
	LDA #$00		; 60fps !!! норм отскок от стены на экране с кунио
	STA скорость_Z_hi_мяча
	LDA #$0D		; 60fps !!! норм отскок от стены на экране с кунио
