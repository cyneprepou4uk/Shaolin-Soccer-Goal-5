...
bra_06_91DA:
	...
	BCC bra_06_91DA
	SEC
	LDA #$00		; 60fps скорость Z смещение мяча относительно игрока во время удара
	SBC $1C
	STA $1C
	LDA #$04		; 60fps скорость Z смещение мяча относительно игрока во время удара
	SBC $1D
	STA $1D
	JSR _подправить_скорости_1C_1D		; 60fps скорость Z смещение мяча относительно игрока во время удара
	LDA $1C
	STA скорость_Z_lo,X
	LDA $1D
	STA скорость_Z_hi,X
