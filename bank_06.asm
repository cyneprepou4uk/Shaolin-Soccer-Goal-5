...
bra_06_9083:
	...
	STA скорость_Z_hi,X
	LDA #$82	; 60fps, добавлено предварительное умножение на 3, а затем проверка с новой таблицей скоростей
	JSR _b07_деление_и_умножение_скоростей_16bit_на_3
	LDA скорость_Z_lo,X
	SBC table_06_90CA_таблица_с_уменьшенной_скоростью,Y
	LDA скорость_Z_hi,X
	SBC table_06_90CA_таблица_с_уменьшенной_скоростью + 1,Y
	BCS bra_06_90B3
	LDA #$00
	STA скорость_Z_lo,X
	STA скорость_Z_hi,X
...
table_06_90CA_таблица_с_уменьшенной_скоростью:		; подправлено под 60 фпс
.word $0055
.word $00AB
.word $00AB
.word $0155
...
; 60fps
; 60фпс слегка уменьшить скорость, попробовать прыгать стоя на мяче и смещаться вбок
table_06_A167_скорость:
.word $0000,	$FFFC		; .word $0000,	$FFF4
.word $0003,	$FFFD		; .word $0008,	$FFF8
.word $0004,	$0000		; .word $000C,	$0000
.word $0003,	$0003		; .word $0008,	$0008
.word $0000,	$0004		; .word $0000,	$000C
.word $FFFD,	$0003		; .word $FFF8,	$0008
.word $FFFC,	$0000		; .word $FFF4,	$0000
.word $FFFD,	$FFFD		; .word $FFF8,	$FFF8
