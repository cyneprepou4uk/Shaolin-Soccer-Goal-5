...
table_06_803F_884E:
	...
	BMI bra_06_8868
	JSR _loc_06_9927_обнулить_анимацию
	LDA #$C0		; 60fps таймер попадания в смерч
	STA таймер_действия,X
	LDA #$08
	JSR _loc_06_9B60
	JSR _loc_06_9FDA
...
table_06_803F_896C:
	...
	LDA сила_ветра
	ADC #$02
.byte $F2,$0C		; DMA умножить на 12	60fps таймер ветряной крутилки
	STA таймер_действия,X
bra_06_898C:
	LDA таймер_действия,X
	BNE bra_06_8994
...
table_06_803F_8A58:
	...
	LDA #$09
	JSR _loc_06_9B60
	LDA #$0D		; 60fps таймер действия коленки увеличен в 3 раза
	STA таймер_действия,X
bra_06_8A7F:
	LDA скорость_Z_hi,X
	...
	LDA скорость_Z_lo,X
	CMP #$F2		; 60fps добавлена проверка младшего байта, 100 - 0E = F2 максимальный предел
	...
	JSR _loc_06_8C32_поделить_скорости_X_Y_на_2
	LDA #$00		; 60fps гравитация после коленки уменьшена в 9 раз, добавлена запись младшего байта
					; в оригинале скорость была 0080, здесь было увеличение до 0180
	STA гравитация_hi,X
	LDA #$2A
	STA гравитация_lo,X
@не_делить_скорости:
...
bra_06_91DA:
	...
	CPY #$03
	BCC bra_06_91DA
	LDY игрок_с_мячом		; 60fps для высокопрыгающих высота набирается медленнее, возможно надо добавить проверку на бота
	LDA номер_скилла,Y
	AND #$04
	BEQ @это_не_высокопрыгающий
	SEC
	LDA #$00		; 60fps скорость Z (при 55 мяч летит ниже чем в оригинале, сделал 90)
	SBC $1C
	JMP @запись
@это_не_высокопрыгающий:
	SEC
	LDA #$80		; 60fps скорость Z (при 55 мяч летит ниже чем в оригинале, сделал 90)
	SBC $1C
@запись:
	STA скорость_Z_lo,X
	LDA #$04		; 60fps скорость Z смещение мяча относительно игрока во время удара
	SBC $1D
	STA скорость_Z_hi,X
	LDA #$00
	STA гравитация_hi,X
	LDA #$0D		; 60fps гравитация смещение мяча относительно игрока во время удара
	STA гравитация_lo,X
	LDA $1E
	STA координата_X_lo,X
	LDA $1F
...
_loc_06_94B2_запись_базовой_гравитации:
	LDA #$0E		; 60fps гравитация мяча когда его с места подбрасываешь, а также чеканка
	STA гравитация_lo,X
	LDA #$00
	STA гравитация_hi,X
	RTS
...
bra_06_954E:
	...
	EOR #$FF
	BEQ bra_06_956B
	JSR _подправить_скорости_30_31		; 60fps скольжение мяча уменьшено в 3 раза
	SEC
	LDA скорость_X_lo,X
	SBC $30
	STA скорость_X_lo,X
...
bra_06_959C:
	...
	EOR #$FF
	BEQ bra_06_95B9
	JSR _подправить_скорости_32_33		; 60fps скольжение мяча уменьшено в 3 раза
	SEC
	LDA скорость_Y_lo,X
	SBC $32
	STA скорость_Y_lo,X
...
_loc_06_97B1_увеличить_таймер_мокр_мяча:
	...
	CMP #$01
	BNE @RTS
	LDA задержка_фпс		; 60fps временное решение
	BNE @RTS
	CLC
	LDA таймер_мокрого_мяча
	ADC #$01
...
_loc_06_98D3:
	...
	ROL $2D
	LDA $2D
	CMP #$1D		; 60fps таймер паса увеличен в 9 раз
...
; 60fps скорость скольжения игрока при подкате, поделена в 8 раз (в 9 не удобно)
...
bra_06_B004:
	...
	LDA сила_мяча
	BNE bra_06_B02A
	LDA #$31		; 60fps таймер при отскоке электрического мяча от игрока
	STA таймер_электрического_мяча
	BNE bra_06_B02A
bra_06_B027:
	JSR _loc_06_9E8B
