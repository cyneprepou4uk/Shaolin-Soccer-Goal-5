...
bra_06_91DA:
	...
	JSR _подправить_скорости_1C_1D		; 60fps	!!! смещение мяча относительно игрока во время удара
	SEC
	LDA #$55		; 60fps !!!скорость Z смещение мяча относительно игрока во время удара
	SBC $1C
	STA скорость_Z_lo,X
...
table_06_8CAF_938D:
	...
	BMI bra_06_939D
	JSR _loc_06_9927
	STA $0526	; на выходе остается 00 и пишется сюда
	LDA #$05
	JSR _loc_06_949C_гравитация_мяча_при_подбросе_и_чеканке
bra_06_939D:
	LDA #$01
...
_подправить_скорости_2C_2D:		; 2 прыжка 60fps !!! корректировка скоростей при скольжении мяча по полю
	LDA $2C
	STA $0192
	LDA $2D
	STA $0193
...
_подправить_скорости_2E_2F:		; 60fps !!! корректировка скоростей при скольжении мяча по полю
	LDA $2E
	STA $0192
	LDA $2F
	STA $0193
...
bra_06_954E:
	...
	EOR #$FF
	BEQ bra_06_956B
	JSR _подправить_скорости_30_31		; 60fps	!!! норм скольжение мяча
	SEC
	LDA скорость_X_lo,X
	SBC $30
	STA скорость_X_lo,X
...
bra_06_956B:
	CLC
	LDA скорость_X_lo,X
	ADC #$02	; 60fps	!!! норм скольжение мяча, уменьшено в 9 раз
	STA скорость_X_lo,X
	LDA скорость_X_hi,X
	ADC #$00
	STA скорость_X_hi,X
...
bra_06_9581:
	SEC
	LDA скорость_X_lo,X
	SBC #$02	; 60fps	!!! норм скольжение мяча, уменьшено в 9 раз
	STA скорость_X_lo,X
	LDA скорость_X_hi,X
	SBC #$00
	STA скорость_X_hi,X
...
bra_06_959C:
	...
	EOR #$FF
	BEQ bra_06_95B9
	JSR _подправить_скорости_32_33		; 60fps	!!! норм скольжение мяча
	SEC
	LDA скорость_Y_lo,X
	SBC $32
	STA скорость_Y_lo,X
...
_подправить_скорости_30_31:		; 60fps корректировка скоростей при скольжении мяча по полю, уменьшено в 9 раз
	LDA $30
	STA $0192
	LDA $31
	STA $0193
...
_подправить_скорости_32_33:		; 60fps корректировка скоростей при скольжении мяча по полю, уменьшено в 9 раз
	LDA $32
	STA $0192
	LDA $33
	STA $0193
