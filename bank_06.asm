...
table_06_8CAF_90DA:
	...
	CLC
	LDA скорость_Z_lo,Y
	ADC #$0E		; 60fps когда игрок прыгает на месте, а мяч летит ему на голову, и он его цепляет головой
	STA скорость_Z_lo,X
	LDA скорость_Z_hi,Y
	ADC #$00
	STA скорость_Z_hi,X
...
; 60fps скорость уменьшена не в 3 раза, а чуть больше, иначе слишком сильно можно было двигаться в полете
