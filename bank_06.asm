...
bra_06_91DA:
	...
	JSR _подправить_скорости_1C_1D		; 60fps	!!! смещение мяча относительно игрока во время удара
	SEC
	LDA #$90		; 60fps !!! скорость Z смещение мяча относительно игрока во время удара ??? недостаточно высоко при 55, мяч летит ниже чем в оригинале
	SBC $1C
	STA скорость_Z_lo,X
