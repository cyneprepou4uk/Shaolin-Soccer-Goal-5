...
.import _b07_F691
.import _b07_F96A
.import _b07_деление_и_умножение_скоростей_16bit_на_4
.import _общий_RTS
...
.export _loc_06_801B_вычислить_скорости_по_углу
_loc_06_801B_вычислить_скорости_по_углу:
	JMP _loc_06_99E8_вычислить_скорости_по_углу
.export _loc_06_801E
_loc_06_801E:
	JMP _loc_06_9A77
.export _loc_06_8021
...
.word table_06_803F_86AA_уворот_стоя_на_мяче
...
table_06_803F_80FA:
	LDA номер_движения,X
	BMI bra_06_8105
	JSR _loc_06_9927_обнулить_анимацию
	JSR _loc_06_9B34
bra_06_8105:
	LDA #$00
	JSR _loc_06_A1F7_сохранить_Y_и_прыгнуть_на_поинтер_таблицы_после_JSR
	JSR _loc_06_9CF8
	LDA #$04
_loc_06_810F:
	JSR _loc_06_9A7A
...
_loc_06_81CF:
	...
	JSR _loc_06_9FDA
	LDA #$06
	JSR _loc_06_99EB_вычислить_скорости_по_углу
bra_06_81E5:
	LDA #$05
	JMP _loc_06_810F
...
table_06_803F_86AA_уворот_стоя_на_мяче:
	LDA номер_движения,X
	BMI @движение_уже_обработано
	JSR _loc_06_9927_обнулить_анимацию
	LDA #$01
	JSR _loc_06_A1F7_сохранить_Y_и_прыгнуть_на_поинтер_таблицы_после_JSR
	LDA направление_движения,X
	...
	EOR #$80
	STA направление_движения,X
@движение_уже_обработано:
	LDA счетчик_фпс_кадров		; 60fps
	AND #$03
	BNE @пропустить_изменение_угла_и_вычисление_скорости
...
@движение_влево:
	...
	LDA #$07
	JSR _loc_06_99EB_вычислить_скорости_по_углу
@пропустить_изменение_угла_и_вычисление_скорости:
	JMP _loc_06_8409
...
table_06_803F_8709:
	...
	STA гравитация_hi,X
	LDA #$08		; 60fps гравитация при падении когда игрок в воздухе чета делает, например бьет
	STA гравитация_lo,X
bra_06_871E:
	JMP _loc_06_8748
...
table_06_803F_884E:
	...
	BMI bra_06_8868
	JSR _loc_06_9927_обнулить_анимацию
	LDA #$FF		; 60fps таймер попадания в смерч увеличен в 4 раза
	STA таймер_действия,X
	LDA #$08
	JSR _loc_06_9B60
	JSR _loc_06_9FDA
...
table_06_803F_896C:
	...
	LDA сила_ветра
	ADC #$02
.byte $F2,$10		; DMA 60fps таймер ветряной крутилки увеличен в 16 раз
	STA таймер_действия,X
bra_06_898C:
	LDA таймер_действия,X
	BNE bra_06_8994
...
; 89C2
.byte $10		; видимо не используется, удалить
...
table_06_803F_8A58:
	...
	LDA #$09
	JSR _loc_06_9B60
	LDA #$11		; 60fps таймер действия коленки увеличен в 4 раза
	STA таймер_действия,X
bra_06_8A7F:
	LDA скорость_Z_hi,X
	BPL @не_делить_скорости
	CMP #$FF
	BNE @не_делить_скорости
	LDA скорость_Z_lo,X
	CMP #$F8		; 60fps добавлена проверка младшего байта, 100 - 08 = F8 максимальный предел
					; в оригинале старший байт был индикатором необходимости увеличить гравитацию, и в следующей проверке байт hi был бы FE
						; а у меня не так быстро уменьшается скорость Z, и при очередном FF скорость снова бы поделилась на 2
	BCC @не_делить_скорости
	JSR _loc_06_8C32_поделить_скорости_X_Y_на_2
	LDA #$00		; 60fps гравитация после коленки уменьшена в 16 раз, добавлена запись младшего байта
					; в оригинале скорость была 0080, а в этом месте было увеличение до 0180
	STA гравитация_hi,X
	LDA #$18
	STA гравитация_lo,X
@не_делить_скорости:
...
bra_06_8D72:
	JSR _loc_06_977B
	JSR _loc_06_97B1_увеличить_таймер_мокр_мяча
	LDA координата_Z_lo,X
	STA $0513
	LDA координата_Z_hi,X
	STA $0514
...
bra_06_8DAD:
	...
	LDA координата_Z_hi,X
	BMI bra_06_8DE4
	LDA счетчик_фпс_кадров		; 60fps задержка анимации бега с мячом, временное решение
	AND #$07
	LSR
	STA $2C
	BNE bra_06_8DE4
	LDA задержка_фпс		; 60fps задержка анимации бега с мячом, временное решение
	BNE bra_06_8DE4
...
bra_06_9083:
	...
	JSR _b07_деление_и_умножение_скоростей_16bit_на_4
	SEC
	ROR скорость_Z_hi,X
	ROR скорость_Z_lo,X
	SEC
...
; после этого игроку присваивается владение мячом, и он может нажать ударить и попадет по мячу независимо от его местоположения
	...
	CLC
	LDA скорость_Z_lo,Y
	ADC #$08		; 60fps принятие мяча игроком, типа голову когда на месте прыгаешь и мяч ударяется об бошку сверху
	STA скорость_Z_lo,X
	LDA скорость_Z_hi,Y
	ADC #$00
	STA скорость_Z_hi,X
...
bra_06_91DA:
	...
	SBC $1D
	STA скорость_Z_hi,X
	LDA #$08		; 60fps гравитация смещение мяча относительно игрока во время удара
	STA гравитация_lo,X
	LDA $1E
	STA координата_X_lo,X
	LDA $1F
...
table_06_8CAF_92D4:
	...
	ROR $2D
	ROR $2C
	LDA #$A0	; 60fps отбивание мяча киперской крутилкой
	JSR _b07_деление_и_умножение_скоростей_16bit_на_4
	LDA #$A1	; 60fps отбивание мяча киперской крутилкой
	JSR _b07_деление_и_умножение_скоростей_16bit_на_4
	CLC
	LDA скорость_Y_lo,X
	ADC $2C
...
bra_06_9342:
	...
	ADC $2D
	STA скорость_X_hi,X
	LDA #$20	; 60fps отбивание мяча киперской крутилкой
	JSR _b07_деление_и_умножение_скоростей_16bit_на_4
	LDA #$21	; 60fps отбивание мяча киперской крутилкой
	JSR _b07_деление_и_умножение_скоростей_16bit_на_4
	JMP _loc_06_92C8
...
bra_06_939D:
	...
	INC таймер_чеканки
	LDA таймер_чеканки
	CMP #$2B		; 60fps таймер чеканки, увеличено в 3 раза
	BCC bra_06_93CE
	LDA #$06
	STA номер_движения,X
bra_06_93CE:
...
bra_06_9428:
	...
	LDA $1C
	BNE bra_06_9402
	LDA #$20		; 60fps скорость переброса мяча через себя
	JSR _b07_деление_и_умножение_скоростей_16bit_на_4
	LDA #$21		; 60fps скорость переброса мяча через себя
	JMP _b07_деление_и_умножение_скоростей_16bit_на_4
...
_loc_06_94B2_запись_базовой_гравитации:
	LDA #$08		; 60fps гравитация мяча когда его с места подбрасываешь, а также чеканка
	STA гравитация_lo,X
	LDA #$00
	STA гравитация_hi,X
	RTS
...
bra_06_954E:
	...
	EOR #$FF
	BEQ bra_06_956B
	JSR _подправить_скорости_30_31		; 60fps скольжение мяча уменьшено в 4 раза
	SEC
	LDA скорость_X_lo,X
	SBC $30
	STA скорость_X_lo,X
...
bra_06_956B:
	CLC
	LDA скорость_X_lo,X
	ADC #$04	; 60fps скольжение мяча уменьшено в 4 раза
	STA скорость_X_lo,X
	LDA скорость_X_hi,X
	ADC #$00
	STA скорость_X_hi,X
...
bra_06_9581:
	SEC
	LDA скорость_X_lo,X
	SBC #$04	; 60fps скольжение мяча уменьшено в 4 раза
	STA скорость_X_lo,X
	LDA скорость_X_hi,X
	SBC #$00
	STA скорость_X_hi,X
...
bra_06_959C:
	...
	EOR #$FF
	BEQ bra_06_95B9
	JSR _подправить_скорости_32_33		; 60fps скольжение мяча уменьшено в 4 раза
	SEC
	LDA скорость_Y_lo,X
	SBC $32
	STA скорость_Y_lo,X
...
_подправить_скорости_30_31:		; 60fps корректировка скоростей при скольжении мяча по полю
	LDA $30
	STA $0192
	LDA $31
	STA $0193
...
_подправить_скорости_32_33:		; 60fps корректировка скоростей при скольжении мяча по полю
	LDA $32
	STA $0192
	LDA $33
	STA $0193
...
; 60fps скорость Y подкрутка уменьшена в 16 раз
...
_loc_06_97B1_увеличить_таймер_мокр_мяча:
	LDA игрок_на_поверхности,X
	CMP #$01
	BNE @RTS
	LDA задержка_фпс		; 60fps временное решение таймера мокрого мяча
	BNE @RTS
	CLC
	LDA таймер_мокрого_мяча
	ADC #$01
...
bra_06_98C3:
	...
	JMP _loc_06_9889
bra_06_98D2:
	LDA #$20		; 60fps скорость обычного удара
	JSR _b07_деление_и_умножение_скоростей_16bit_на_4
	LDA #$21
	JMP _b07_деление_и_умножение_скоростей_16bit_на_4
...
_loc_06_98D3:
	...
	ROL $2D
	LDA $2D
	CMP #$10		; 60fps таймер паса увеличен в 9 раз
	BCC @недостаточно_много
	LDA #$FF
	BNE @запись_таймера
@недостаточно_много:
.byte $F2,$10	; DMA умножить на 16
@запись_таймера:
	STA таймер_прицельного_паса
...
_loc_06_9927_обнулить_анимацию:
...
_loc_06_99E8_вычислить_скорости_по_углу:
	LDA $0493
_loc_06_99EB_вычислить_скорости_по_углу:
	AND #$0F
	ASL
	ASL
	ASL
...
; 60fps скорость скольжения игрока при подкате, поделена в 16 раз
table_06_9AFC_скорость:
.word $0005		; $0050 оригинал
.word $0001		; $0010
.word $0006		; $0060
.word $0006		; $0060
.word $000A		; $00A0
...
_loc_06_9B60:
	...
	STA скорость_Z_hi,X
	LDA #$08		; 60fps гравитация
	STA гравитация_lo,X
	LDA #$00
	STA гравитация_hi,X
	RTS

; 60fps скорость падения прыжка уменьшена в 4 раза
...
bra_06_9FFC:
	...
	LDA #$08		; 60fps гравитация мяча, когда игрок в воздухе, его сшибли коленкой, он выпустил мяч и тот опускается
...
; 60fps скорость смещения в воздухе уменьшена до минимума
table_06_A167_скорость:
.word $0000,	$FFFE		; .word $0000,	$FFF4 - оригинал,	$0000,	$FFFC - предыдущее изменение
.word $0001,	$FFFF		; .word $0008,	$FFF8           	$0003,	$FFFD
.word $0002,	$0000		; .word $000C,	$0000           	$0004,	$0000
.word $0001,	$0001		; .word $0008,	$0008           	$0003,	$0003
.word $0000,	$0002		; .word $0000,	$000C           	$0000,	$0004
.word $FFFF,	$0001		; .word $FFF8,	$0008           	$FFFD,	$0003
.word $FFFE,	$0000		; .word $FFF4,	$0000           	$FFFC,	$0000
.word $FFFF,	$FFFF		; .word $FFF8,	$FFF8           	$FFFD,	$FFFD
...
_loc_06_A1F7_сохранить_Y_и_прыгнуть_на_поинтер_таблицы_после_JSR:
...
bra_06_A220:
	...
	BEQ bra_06_A230
	LDA #$04
	JMP _loc_06_A2D1_запись_в_подтипАнимации
bra_06_A230:
	LDA номер_команды,Y
	AND #$0F
	CMP #$0F
	...
	LSR
	TAY
	LDA table_06_A242_подтипАнимации,Y
	JMP _loc_06_A2D1_запись_в_подтипАнимации

table_06_A242_подтипАнимации:
...
@продолжить:
	...
	LSR
	TAY
	LDA table_06_A287_подтипАнимации,Y
	JMP _loc_06_A2D1_запись_в_подтипАнимации

table_06_A287_подтипАнимации:
; отрицательные байты не будут записаны
...
_loc_06_A2D1_запись_в_подтипАнимации:
	BMI @не_записывать
	STA подтип_анимации,X
@не_записывать:
	RTS
...
bra_06_A586:
	...
	SBC $1C
	STA скорость_Z_hi,X
	LDA #$22		; 60fps гравитация паса
	JSR _b07_деление_и_умножение_скоростей_16bit_на_4
	LDA #$08		; 60fps гравитация паса
	STA гравитация_lo,X
	LDA #$00
	STA гравитация_hi,X
	RTS
...
animation_10:
.byte $F0,$02,$01,$20,$02,$06,$01,$0D,$F0,$0B,$03,$0D,$FF		; 60fps временно увеличен таймер анимации подброса мяча через себя
...
animation_0D_sub_02:
.byte $05,$0D,$FF		; 60fps временно увеличен таймер анимации подброса мяча пяткой с места
; .byte $04,$0D,$FF
...
animation_0E:
.byte $01,$18,$F0,$0A,$04,$18,$FF		; 60fps временно увеличен таймер анимации подброса мяча коленкой с места
...
bra_06_B004:
	...
	LDA сила_мяча
	BNE bra_06_B02A
	LDA #$30		; 60fps таймер при отскоке электрического мяча от игрока, увеличен в 3 раза
	STA таймер_электрического_мяча
	BNE bra_06_B02A
bra_06_B027:
	JSR _loc_06_9E8B
...
; 60fps отскок мяча от перекладины, уменьшено в 4 раза
table_06_BC3C_скорость_Z:
.word $FE00		; .word $F800 оригинал
.word $FD80		; .word $F600
.word $FF00		; .word $FC00
.word $0000		; .word $0000
.word $0040		; .word $0100
